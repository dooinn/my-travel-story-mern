...
import followingIcon from '../assets/followings.png'
    ...
    return (
        <Section>
            <div className="section-header">
                <img className="icon-image" src={followingIcon} alt="explore icon"></img>
                <div className="hero-text-container">
                    <h1 className="hero-text">My Followings</h1>
